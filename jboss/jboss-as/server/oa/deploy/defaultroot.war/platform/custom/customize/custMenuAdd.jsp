...
<%
  ...
  String validate_s=request.getParameter("validate")==null?"":com.whir.component.security.crypto.EncryptUtil.htmlcode(request.getParameter("validate"));
  if(null!= validate_s && !"".equals(validate_s) && !"null".equals(validate_s)){
	validate_s = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(validate_s);
  }
...
<body class="Pupwin" >  
	<div class="BodyMargin_10">    
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline"> 
             <input name="trigId" type="hidden" id="trigId" value="0">		
		   <tr>    
			   ...
			   <td>
				   <select id="menuBlone"  name="menuBlone" class="selectlist" style="width:200px;" onchange="changeSub(this.value);">    
				    ...
				    <div id="mainmenuorder" style="display:inline;">
                     主菜单排序码：<input class="inputText"  name="parentOrder" id="parentOrder" style="width:150px;" whir-options="vtype:['p_integer_e',{'range':'0-9999'}]" maxlength="9">
					</div>
			   </td>    
		   </tr>
           <tr>    
		  ...
		  <tr id="mobileEnterpriseId" style="display:none">    
		  ...
		  <tr id="linkTR2" style="display:none">
			<td>&nbsp;</td>
			<td valign="top" align="left" style="padding: 6px 2px 6px 45px;">
				...
				<table>
					 ...
					 <tr id="tr_relationTrig" style="display:none">
						  <td valign="top">字段联动：&nbsp;&nbsp;&nbsp;
						  <select name="relationTrig" id="relationTrig" style="width:200px;"><option value="">--</option>
						  </select>
						  </td>	
                          <td>&nbsp;</td>						 
					 </tr>               
...
function resetDataForm(){
  location_href('<%=rootPath%>/custormermenu!addCustMenu.action?validate=<%=validate_s%>');
}
