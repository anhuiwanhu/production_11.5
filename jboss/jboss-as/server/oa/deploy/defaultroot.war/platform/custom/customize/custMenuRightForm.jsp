...
<html xmlns="http://www.w3.org/1999/xhtml" class="<%=whir_2016_skin_color%> size-big">  
<head>  
	<title>业务处理列表</title>  
...
<link rel="stylesheet" href="<%=rootPath%>/template/css/template_default/themes/2016/template.theme.media.min.css" type="text/css">
</head>  
<%
  ...
  **/
  ...
  Long trigSettingId = (Long)request.getAttribute("trigSettingId");
...
<body class="MainFrameBox">  
	...
	<input name="trigSettingId" id="trigSettingId" value="<%=trigSettingId%>" type="hidden">
    <!-- SEARCH PART START -->  
