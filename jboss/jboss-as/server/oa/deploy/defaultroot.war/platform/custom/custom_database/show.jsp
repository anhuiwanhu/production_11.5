        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align=center>
                    ...
                    <font id="remark202" name="remark202" style="display:none"><label class="MustFillColor">用于存储登录人姓名。（只适用于字符型字段，使用签名图片按钮只支持ezFLOW流程引擎）</label></font>
                    ...
                    <font id="remark215" name="remark215" style="display:none"><label class="MustFillColor">用于存储当前办理人姓名。（只适用于字符型字段，使用签名图片按钮只支持ezFLOW流程引擎）</label></font>
