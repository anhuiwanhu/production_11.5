						...
						<tr>
						    ...
						    <tr> 
								...
								<td>
									...
									<INPUT value="true" type="checkbox" name="processDealUserWithRepeat"><!--办理人重复时自动跳过--><s:text name="workflow.dealUserWithRepeat"/>
								 </td>
								 <td></td>		
							  </tr> 
						     ...
						     <tr id="addSignTR"  style="display:none">
				                 <td colspan="2">
								   <div style="padding-left:66px;">
									 ...
									 <INPUT TYPE="radio" NAME="EzFlowAddSignTask"   value="5" onClick="showTranTR();"><s:text name="workflow.activitytranorgandsub"/><!-- 本组织及下属组织 -->
							 ...
							 <tr id="tranReadTR"  style="display:none">
								<td colspan="2">
								  <div style="padding-left:66px;">
									  ...
									  <INPUT TYPE="radio" NAME="EzFlowTranRead"   value="5" onClick="showTranTR();"><s:text name="workflow.activitytranorgandsub"/><!-- 本组织及下属组织 -->
							  ...
							  <tr id="edaddSignTR"  style="display:none">
				                 <td colspan="2">
								   <div style="padding-left:66px;">
									 ...
									 <INPUT TYPE="radio" NAME="EdAddSign"   value="5" onClick="showTranTR();"><s:text name="workflow.activitytranorgandsub"/><!-- 本组织及下属组织 -->
