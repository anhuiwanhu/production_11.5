...
<s:hidden  name="p_wf_formId"        id="p_wf_formId"/> 
...
function  showDealtipsContent(){
   ...
   <%  
		...
		String p_wf_activityTipTitle=request.getAttribute("p_wf_activityTipTitle")==null?"0":request.getAttribute("p_wf_activityTipTitle").toString();
		String p_wf_activityTipCotent=request.getAttribute("p_wf_activityTipCotent")==null?"0":request.getAttribute("p_wf_activityTipCotent").toString();
   %>
