...
function initData() {
	...
	*/
	...
	//var subTableDataControlAddRadio = $("input[name='subTableDataControlAdd'][value='" + model.getAttribute("whir:subTableDataControlAdd") + "']");
	//if(subTableDataControlAddRadio.length > 0) {
		//subTableDataControlAddRadio[0].checked = true;
	//}
	...
	//var subTableDataControlAddNullRadio = $("input[name='subTableDataControlAddNull'][value='" + model.getAttribute("whir:subTableDataControlAddNull") + "']");
	//if(subTableDataControlAddNullRadio.length > 0) {
	//	subTableDataControlAddNullRadio[0].checked = true;
	//}
	...
	//var subTableDataControlModiRadio = $("input[name='subTableDataControlModi'][value='" + model.getAttribute("whir:subTableDataControlModi") + "']");
	//if(subTableDataControlModiRadio.length > 0) {
	//	subTableDataControlModiRadio[0].checked = true;
	//}

	//whir:subTableDataControlDel 允许删除已有行数据
	//var subTableDataControlDelRadio = $("input[name='subTableDataControlDel'][value='" + model.getAttribute("whir:subTableDataControlDel") + "']");
	//if(subTableDataControlDelRadio.length > 0) {
	//	subTableDataControlDelRadio[0].checked = true;
	//}
