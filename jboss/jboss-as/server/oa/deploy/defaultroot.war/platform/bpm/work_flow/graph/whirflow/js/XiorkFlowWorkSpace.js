...
//
XiorkFlowWorkSpace.BASE_PATH = CommonJSResource.rootPath+"/platform/bpm/work_flow/graph/";
...
XiorkFlowWorkSpace.URL_GET_PROCESS = CommonJSResource.rootPath+"/WFDesignerServlet";
XiorkFlowWorkSpace.URL_LIST_PROCESS = XiorkFlowWorkSpace.BASE_PATH + "listprocess.xf";
XiorkFlowWorkSpace.URL_UPDATE_PROCESS = CommonJSResource.rootPath+"/WFDesignerServlet";
...
//
XiorkFlowWorkSpace.META_NODE_MAX = 70;
...
XiorkFlowWorkSpace.build = function () {
    ...
    BuildLibrary.loadJS(CommonJSResource.rootPath+ "/scripts/jquery-1.11.2.min.js");
	...
	//BuildLibrary.loadJS(CommonJSResource.rootPath+ "/scripts/plugins/form/form.css"); 
