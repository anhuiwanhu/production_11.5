...
<%
  ...
  String _rrecordId =com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"rrecordId");
  String _rmoduleId =com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"rmoduleId");
%>
...
<script type="text/javascript">  
	...
	*/
	...
	　　　  }) 
			...
			if('<%=_rmoduleId%>,<%=_rrecordId%>'==(obj.moduleId+','+obj.workRecordId)){
	...
	　　　  });
			...
			var url="<%=rootPath%>/wfoperate!addBpmRelationWork.action?p_wf_moduelId="+obj.moduleId+"&p_wf_recordId="+obj.workRecordId+"&rmoduleId=<%=_rmoduleId%>&rrecordId=<%=_rrecordId%>"; 
