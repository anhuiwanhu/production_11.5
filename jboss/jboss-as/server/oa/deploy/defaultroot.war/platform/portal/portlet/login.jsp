    ...
    <form id="LogonForm" name="LogonForm" action="Logon!logon.action" method="post" target="_self">
		...
		<div class="wh-portal-l-check clearfix">
             <div class="wh-portal-l-select">
                 ...
                 <ul class="lang-list">
                     <li value="zh_CN" data="zh_CN">简体中文</li>
                     <li value="zh_TW" data="zh_TW">繁体中文</li>
                     <li value="en_US" data="en_US">English</li>
                     <li value="ko_KR" data="ko_KR">韩国语</li>
                     <li value="ja_JP" data="ja_JP">日本语</li>
                 </ul>
             </div>
...
$(document).ready(function(){
	$("#chooseLanguage").click(function(){
	    ...
	    $("ul.lang-list li").click(function(){
	        ...
	        $("ul.lang-list").hide();
			//20160718 - by jqq 登录语言有误/提示信息有误 改造
	        $("#localeCode").val($(this).attr("data"));
	    })
	})
...
function submitForm(){
	...
	$.ajax({
			url: "/defaultroot/Logon!getSysTime.action",
			cache: false,
			async: true,
				...
				if(data.result=="true"){
					...
					if ($("input[name='remember']:checked").val()=='1') {
						...
						if(passWord.length<80){
							...
							document.LogonForm.userPasswordTemp.value=RSAUtils.encryptedString(key, passWord);
							document.LogonForm.userPassword.value=RSAUtils.encryptedString(key, p);
							$.cookie("userPassword", RSAUtils.encryptedString(key, passWord), { expires: 365 });
							
						}else{
							
							var key = RSAUtils.getKeyPair("010001", "", "");
							document.LogonForm.time.value=RSAUtils.encryptedString(key, time);
