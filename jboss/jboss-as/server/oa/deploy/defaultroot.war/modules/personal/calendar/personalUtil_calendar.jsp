...
<HTML>
    <HEAD>
        ...
        <script type="text/javascript" src="<%=rootPath%>/modules/personal/calendar/json.js"></script>
        ...
        */
        ...
        function drawCld(SY,SM) {
            ...
            for(i=0;i<42;i++) {
                ...
                if(sD>-1 && sD<cld.length) { //日期内
                    ...
                    if(cld[sD].isToday) {
                        sObj.className = 'SD todyaColor'; //今日颜色
                    }
        ...
        function mOut() {
            ...
            if ( sw == 0 ) { 
                snow = 0; if(dStyle)dStyle.visibility = "hidden";
            } else {
                cnt++;
            }
        }
        ...
        function initial() {
			// Modified by Qian Min for ezOFFICE 11.0.0.11 [BEGIN]
			if (isPad()) {
				$('#worldmap').remove();
			} else {
			...
			// Modified by Qian Min for ezOFFICE 11.0.0.11 [END]
            dStyle = detail.style;
            CLD.SY.selectedIndex=tY-1900;
            CLD.SM.selectedIndex=tM;
            drawCld(tY,tM);
		...
		// Added by Qian Min for ezOFFICE 11.0.0.11 [BEGIN]
		// 判断当前访问的设备是不是PAD
		function isPad(){
		...
		// Added by Qian Min for ezOFFICE 11.0.0.11 [END]
        //-->
        </SCRIPT>
    ...
    <BODY leftMargin=0 topMargin=0>
        ...
        <CENTER>
                    ...
                    <TBODY>
                        <TR>
                                ...
                                <P>
                                    <FONT style="FONT-SIZE: 9pt" size=2> 
                                        <SELECT style="FONT-SIZE: 9pt" onchange=changeTZ() name=TZ>
                                            <OPTION value="-1200 安尼威土克、瓜甲兰" selected>国际换日线</OPTION>
                                            ...
                                            <OPTION value="+0800 北京、重庆、黑龙江">中国</OPTION>
                                    ...
                                    <BR>
                                    <FONT
                                        style="FONT-SIZE: 120pt; COLOR: green; FONT-FAMILY: Webdings"
                                        id="worldmap">&ucirc;</FONT>
                                    <BR>
                                    <FONT id=CITY
                                    ...
                                    <TBODY>
                                        <TR>
                                            <TD bgColor=#000080 colSpan=7>
                                                ...
                                                <FONT id=GZ face=标楷体 color=yellow size=3></FONT>
                                                <BR>
                                            </TD>
                                        </TR>
                            ...
                            <TD vAlign=top align=middle width=40>
                                ...
                                <BR>
                                <BR>
                                <input type="button" class="btnButton4font" value='上一年' onclick="pushBtm('YU');" />
                                <BR>
                                <input type="button" class="btnButton4font" value='下一年' onclick="pushBtm('YD');" />
                                <BR>
                                <input type="button" class="btnButton4font" value='上一月' onclick="pushBtm('MU');" />
                                <BR>
                                <input type="button" class="btnButton4font" value='下一月' onclick="pushBtm('MD');" />
                                <BR>
                                <input type="button" class="btnButton4font" value='今&nbsp;&nbsp;日' onclick="pushBtm('');" />
                            </TD>
                        </TR>
                    </TBODY>
                </TABLE>
            ...
            <FONT style="FONT-SIZE: 9pt" face=ARIAL size=2>阳历中
                <FONT color=red>红色</FONT>/<FONT color=green>绿色</FONT>
                表示节假日，农历中
                <FONT color=green>绿色</FONT>表示为24节气日，
                <FONT color=red>红色</FONT>表示为传统节日，
                <FONT color=blue>蓝色</FONT>则表示为公众节假日
            </FONT>
