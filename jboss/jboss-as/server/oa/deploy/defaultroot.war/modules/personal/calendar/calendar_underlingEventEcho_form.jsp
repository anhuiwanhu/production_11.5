                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline">
                    ...
                    <tr>  
                        <td for='<s:text name="myworklog.selectemp"/>' class="td_lefttitle" width="11%">  
                    ...
                    <tr>  
                        ...
                        %>
                             <select name="formEventBeginHours" id="formEventBeginHours"  class="selectlist" style="width:8%;" >
                            <%
                                 for(int i=0; i<24; i++){
                       ...
                       <%
                        ...
                        %>
                            <select name="formEventEndHours" id="formEventEndHours" class="selectlist" style="width:8%;" >
                            <%
                               for(int i=0; i<24; i++){
                                        int optValue = i*3600;
                                        String optText = (i<10?"0":"") + i ;
                    ...
                    <tr>  
                        ...
                        <td>
                            <input type="text" class="Wdate whir_datebox" name="formEchoBeginDate" id="formEchoBeginDate" value='<s:property value="#request.formEchoBeginDate" />' onfocus="WdatePicker({el:'formEchoBeginDate',isShowWeek:true, isShowClear:false, readOnly:true, maxDate:'#F{$dp.$D(\'formEchoEndDate\')||\'%y-%M-%d\'}'})"/>
