...
<%@page import="com.whir.component.security.crypto.EncryptUtil"%>                
                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline">
                    ...
                    <tr>  
                        ...
                        <td width="15%"> 
                            <input type="text" class="Wdate whir_datebox" name="formEventBeginDate" id="formEventBeginDate" value='<%=EncryptUtil.replaceHtmlcode(request.getAttribute("formEventBeginDate").toString()) %>' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"  /> 
                        </td>  
                       <td id="td_beginTime" width="12%">
                        ...
                        <td >  
                            ...
                            <s:else>
                                 <s:if test="#request.event.getEventFullDay()==0||eventId==null">
                                      <s:radio name="event.eventFullDay" id="eventFullDay" list="%{#{'1':getText('rtx.Yes'),'0':getText('rtx.No')}}" value="0" theme="simple" onclick="changeEventFullDay(this.value);"></s:radio>
				                            </s:if>
				                            <s:else>
				                                  <s:radio name="event.eventFullDay" id="eventFullDay" list="%{#{'1':getText('rtx.Yes'),'0':getText('rtx.No')}}" value="1" theme="simple" onclick="changeEventFullDay(this.value);"></s:radio>
				                            </s:else>
                            </s:else>
                    ...
                    <tr>  
                        ...
                        <td> 
                            <input type="text" class="Wdate whir_datebox" name="formEventEndDate" id="formEventEndDate"  value='<%=EncryptUtil.replaceHtmlcode(request.getAttribute("formEventEndDate").toString()) %>' onfocus="WdatePicker({el:'formEventEndDate',isShowWeek:true, isShowClear:false, readOnly:true, minDate:'#F{$dp.$D(\'formEventBeginDate\')}'})"/>  
                        </td> 
