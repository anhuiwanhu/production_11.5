...
<head>
    <title><s:text name="personalwork.view" /><s:text name="schedule.mySchedule" /><s:text name="calendar.periodic" /></title>
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
    <%@ include file="/public/include/meta_base.jsp"%>
    <%@ include file="/public/include/meta_detail.jsp"%>
    <!--这里可以追加导入模块内私有的js文件或css文件-->
    <script src="<%=rootPath%>/modules/personal/calendar/calendar_myEventEcho_js.js" type="text/javascript"></script>
            ...
            <s:form name="dataForm" id="dataForm" action="${ctx}/EventAction!viewMyEvent.action" method="post" theme="simple" >
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline">
                    ...
                    <tr>  
                        ...
                        <td>
                            <input type="text" class="Wdate whir_datebox" name="formEchoBeginDate" id="formEchoBeginDate" value='<s:property value="#request.formEchoBeginDate" />' disabled="true" />
                            <span id="span_formEchoEndDate">
                            &nbsp;<s:text name="calendar.to"/>&nbsp;
                            <input type="text" class="Wdate whir_datebox" name="formEchoEndDate" id="formEchoEndDate" value='<s:property value="#request.formEchoEndDate" />' disabled="true" />  
                            </span>
                    ...
                    <tr>  
                        ...
                        <td>  
                            ...
                            <s:textfield name="event.attend" id="attend" cssClass="inputText" cssStyle="width:98%;" disabled="true" />  
                        </td> 
                    </tr>  
                    ...
                    <tr>  
                        ...
                        <td >  
                            <s:if test="#request.event.eventRemind==null" >
                                <s:radio name="event.eventRemind" id="eventRemind" list="%{#{'1':getText('rtx.Yes'),'0':getText('rtx.No')}}" value="0" theme="simple" disabled="true" ></s:radio>
                            </s:if>
                            <s:else>
                    ...
                    <tr>
                        <td colspan="5">
                            <table width="99%" border="0" cellspacing="0" cellpadding="0" class="docBoxNoPanel">
                                <tr>
                                    <td width="10%" align="center" class="outRightLine" valign="top" bgcolor="#dddddd">
                                        <s:text name="comment.person"/>
                                    </td>
                                    <td width="60%" align="center" class="outRightLine" valign="top" bgcolor="#dddddd">
                                        <s:text name="comment.content"/>
                                    </td>
                                    <td width="20%" align="center" class="outRightLine" valign="top" bgcolor="#dddddd">
