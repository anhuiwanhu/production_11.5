...
<%
    ...
    if(null!= pageSubject && !"".equals(pageSubject) && !"null".equals(pageSubject)){
		mailsubject = pageSubject;
    }
   ...
   //外部输入收件人
   String empId= com.whir.component.security.crypto.EncryptUtil.htmlcode(request.getParameter("empId"));
   if(null!= empId && !"".equals(empId) && !"null".equals(empId)){
		empId = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(empId);
   }
   String empName= com.whir.component.security.crypto.EncryptUtil.htmlcode(request.getParameter("empName"));
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline">
		   ...
		   <tr>    
			   ...
			   <td>  
				  ...
				  <input type="hidden" name="informationIdForMail" value="<%=com.whir.component.security.crypto.EncryptUtil.htmlcode(request.getParameter("informationIdForMail"))%>">
                  <input type="hidden" name="channelIdForMail" value="<%=com.whir.component.security.crypto.EncryptUtil.htmlcode(request.getParameter("channelIdForMail"))%>">
			   </td>    
		   </tr> 
	     </table>
