...
%>
	...
	function downloadLink(po,i){
		var url = '<%=smartInUse==1?"/defaultroot/public/download":fileServer%>/download.jsp?verifyCode='+po.verifyCode1+'&FileName='+po.goldGridId+'.doc&name='+encodeURIComponent(po.documentSendFileTitle)+po.documentWordType+'&path=govdocumentmanager';
