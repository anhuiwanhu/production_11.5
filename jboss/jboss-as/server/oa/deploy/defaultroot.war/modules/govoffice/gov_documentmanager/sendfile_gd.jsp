...
if(request.getParameter("gd") != null){
	...
	//System.out.println("===========================createdEmp========="+createdEmp);
    java.util.HashMap hmap = new com.whir.govezoffice.documentmanager.bd.SendFileBD().getUserOrg(createdEmp);
	//System.out.println("===========================org========="+hmap.get("orgId"));
	String createdOrg = hmap==null?"":hmap.get("orgId").toString();
	//String createdOrg = session.getAttribute("orgId").toString();
   // new com.whir.ezoffice.archives.action.ArchivesAction().addArchivesWaitPigeonhole(request.getParameter("fileTitle"),tmp,Long.valueOf(request.getParameter("fileId")),"GWGL",session.getAttribute("userName").toString(), new java.util.Date(), returnValue, request, createdEmp, createdOrg,"FWGL");
	 java.io.File file = new java.io.File(fileName);

    /*java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.FileOutputStream(fileName));
    pw.println("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><title>发文归档</title></head>");
    ...
    pw.close();*/
        ...
        OutputStreamWriter os = null;
         try {
            ...
            // os.write("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><title>发文归档</title><script  src=\"" + rootPath + "/js/utfTooljs.js\"  language=\"javascript\" ></script><script  src=\"" + rootPath + "/js/util/tool.js\"  language=\"javascript\" ></script></head>\n"+"<body onload=\"init();\" leftmargin=0 topmargin=0>\n"+pageContent+"</body></html>");
...
<%    
     ...
     Boolean b=dossierBD.gdDossier(request.getParameter("fileId"),"FWGL",request.getParameter("fileTitle"),request.getParameter("wh"),null,null,null,dateString1,null,null,uname,null,createdEmp,createdOrg,dateString2,session.getAttribute("domainId").toString(),"htm",tmp,null,null,request.getParameter("zwurl"));//request.getParameter("org")
%>
...
%>
    ...
    //url=encodeURI(url);
	document.getElementById("gd").src=url;
