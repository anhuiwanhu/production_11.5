...
<body class="MainFrameBox" onload="init()">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="toolbarBottomLine">
	    <tr>
	        <td align="right">
			   ...
			   <input name="" type="button" value="选中导出" class="btnButton4font" style="display:"  onClick="exportExcel(1);"/>
			   <input name="" type="button" value="导　出" class="btnButton4font" style="display:"  onClick="exportExcel(0);"/>
	           <%}%>
	...
	function show(po,i){
		...
		var html =  '<a href="javascript:void(0)" onclick="openWin({url:\'GovDocSendProcess!viewfile.action?toMe=<s:property value="%{#request.parameters.toMe}"/>&p_wf_recordId='+po.id+'&canFFfj='+po.canFFfj+'&canDownLoad='+po.canDownload+'&p_wf_tableId='+po.tableId+'\',width:620,height:290,isResizable: true,isFull: true,winName:\'showUser\'});">'+po.title+'</a>';
		<%}else{%>
		var html =po.title;
		<%}%>
		return html;
...
%>
	...
	function exportExcel(flag) {
		...
		var params = '?selectIds='+ids+'&exportData=1&isHandingFile=1&exportTitle=发文管理-分发文件查阅导出';
	 
		commonExportExcel({formId:'queryForm', action:'/defaultroot/GovDocSend!exportHandoutFileList.action'+params});
	}
