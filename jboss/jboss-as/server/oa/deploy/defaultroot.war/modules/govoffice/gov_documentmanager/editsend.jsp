...
String  qianfaName="";
String  qianfaTime="";
String [] qianfaStr=new 
com.whir.ezoffice.bpm.bd.BPMCommonBD().getCommentUserAndDateByCommField((String)request.getAttribute("p_wf_tableId"),(String)request.getAttribute("p_wf_recordId"),"documentSendFileSendFile","2");
