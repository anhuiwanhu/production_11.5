...
function cmdChangeNumber(){
	...
	//openPupWin("/defaultroot/GovSendFileAction.do?action=initZjkySendWord&sendWordId="+sendWordId+"&changeNumType=add",400,200);
   				popup({id:'cmdChangeNumber_pop',title: '编号',fixed: true, left: '50%', top: '50%',width:'650px',height:'180px',padding: 0,drag: true, resize: true,lock: true,content: 'url:GovDocSend!initZjkySendWord.action?sendWordId='+sendWordId+'&changeNumType=add'});
		   }
