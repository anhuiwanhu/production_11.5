...
<%}%>
<%
String govFormType=request.getParameter("govFormType")==null?"":com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"govFormType");

String sendFileId=request.getParameter("sendFileId")==null?"":com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"sendFileId");
...
String filetitle=request.getParameter("filetitle")==null?"":com.whir.component.security.crypto.EncryptUtil.htmlcode(request,"filetitle");
...
<%=filetitle + "收文接收情况："%>
	...
	<s:form name="queryForm1" id="queryForm1" action="%{#ctx}/GovDocSend!sendAssociateData.action" method="post" theme="simple">
<input type="hidden" name="sendFileId" value="<%=sendFileId%>"/>
	<!-- SEARCH PART START -->
