...
String  nowSend=rutil.getRealTimeMessageType();
    Boolean sfRTX=sysRed.hasRtxOnline(CommonUtils.getSessionDomainId(request).toString());
		     ...
		     <tr>  
              ...
              <tr class="toolbarBottomLine">
                ...
                <td  align="left">   
					...
					<input type="button" name="Cancel" value="取　消" class="btnButton4font" onclick="api.close()" />
                </td>  
	...
	if( $("*[name='candidateId']").val()==""){
		 whir_alert("请选择接收人！");
			...
			if ($.browser.msie ) { 
                ...
                if( $("*[name='sendFileFFfj']").length>0){
                    if($("*[name='sendFileFFfj']")[0].checked){
                        if(W.document.getElementsByName("sendFileFFfj").length>0){
                            //$("*[name='sendFileNeedMail']",W.document).val("1");
                            W.document.getElementsByName("sendFileFFfj")[0].value = "1";
                        }
                    }
                }
