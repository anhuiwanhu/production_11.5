...
<body  <%if( !"1".equals( request.getParameter("isPrint"))){ %>class="docBodyStyle" style="position:relative; height:100%;" <%}else{%>scroll=yes<%}%>    onload="initBody();">
       <!--包含头部--->
	 ...
	 <table border="0"  cellpadding="0" cellspacing="0" height="100%" align="center" class="doc_width">
         <tr valign="top">
             <td height="100%"  align="center">
	            <div class="docbox_noline"   align="center" > <%if( !"1".equals( request.getParameter("isPrint"))){ %>
					   ...
					   <%if( "1".equals( request.getParameter("isPrint"))){ %>
							<div align="right" style="margin-top:20px"><input type="button" class="btnButton4font noprint" value="打　印" onclick="window.print();">
                       ...
                       <div id="docinfo0" class="doc_Content"  align="center">
							...
							String add = "/modules/govoffice/gov_documentmanager/forms/view_"+tableId_form+"_sendfilecheckform_include.jsp"; 
							File file = new File(request.getRealPath("") +   add);
							if (!file.exists()) {
								new com.whir.govezoffice.documentmanager.actionsupport.GovCustomAction().replayGovCustomPage(request,tableId_form,"2","1");
							}
							%> 
