...
<%
	String ptMasterId = request.getAttribute("ptMasterId")==null?"":request.getAttribute("ptMasterId").toString();
...
<body>
<s:form name="queryForm" id="queryForm" action="/intoStockAction!getPtDetail.action" method="post" theme="simple">
...
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  	...
	  	<tr>
        	...
        	<td width="20%" valign="bottom" class="bottomLine"><s:if test="ptMasterPO.ptSupp != null && ptMasterPO.ptSupp != 'null'"><s:property value="ptMasterPO.ptSupp"/></s:if>&nbsp;</td>
        	<td width="4%"  valign="bottom">&nbsp;</td>
        	<td width="8%"  valign="bottom" align="center">发票号码</td>
        	<td width="20%" valign="bottom" class="bottomLine"><s:if test="ptMasterPO.invoiceNO != null && ptMasterPO.invoiceNO != 'null'"><s:property value="ptMasterPO.invoiceNO"/></s:if>&nbsp;</td>
        	<td width="4%"  valign="bottom">&nbsp;</td>
  ...
  <input type="hidden" name="ptMasterId" value="<%=ptMasterId%>">
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999" class="listTable">
      	<thead id="headerContainer">
	    	<tr class="listTableHead">
        		...
        		<td align="center" bgcolor="#dddddd" whir-options="field:'mcost',width:'10%'">单价</td>
  ...
  <tr>
    <td>
	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" >
  	 	<tr>
     		<td>每页&nbsp;<input type="text" name="pageNum" id="pageNum" onkeyup="checkNUM(this);" size="3" maxlength="2">&nbsp;条&nbsp;<input type="button" onClick="change();" value="<s:text name="comm.confirm"/>" class="btnButton4font"/>&nbsp;<input type="button" onClick="myprint();" value="<s:text name="comm.print"/>" class="btnButton4font"/></td>
        </tr>
     </table>
    </td>
  </tr>
...
<script type="text/javascript">
	...
	function myprint(){
	    ...
	    openWin({url:'<%=rootPath%>/intoStockAction!print.action?ptMasterId=<%=ptMasterId%>&mode=<%=mode%>&stockId=<%=stockId%>&perPageCount='+para+'',isFull:true,winName:'打印采购进货信息'});
	}
</script>
</html>