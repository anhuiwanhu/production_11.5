...
<!--
	function viewDetailDirectly(boardroomApplyId,boardroomName,meetingId){
		 var url='<%=rootPath%>/boardRoom!readOldMeeting.action?directlyPublish=1&p_wf_recordId='+boardroomApplyId+'&title='+encodeURIComponent(boardroomName)+'&p_wf_openType=modifyView&p_wf_moduleId=15&isView=true&executeStatus=true&fromAdr=userList&meetingId='+meetingId;
