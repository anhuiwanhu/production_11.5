...
<body class="Pupwin">
	<div class="BodyMargin_10">
		<div class="docBoxNoPanel">
	       <s:form name="dataForm" id="dataForm" action="/outStockAction!saveOutStock.action" method="post" theme="simple" >
	          ...
	          <table width="98%" border="0" cellpadding="2" cellspacing="0" class="Table_bottomline" style="margin:0 auto;">
	              ...
	              <tr>
	                  <td for="<%=mode.equals("outStock")?"出库":"退库"%>日期" width="9%" class="td_lefttitle" nowrap><%=mode.equals("outStock")?"出库":"退库"%>日期<span class="MustFillColor">*</span>：</td>
	                  <td width="40%">
	                      <s:textfield name="ssMasterPO.ssDate" id="ssDate" cssClass="Wdate whir_datebox" whir-options="vtype:['notempty']" onclick="WdatePicker({el:'ssDate',dateFmt:'yyyy-MM-dd',readOnly:true})" >
	              ...
	              <tr>
				      <td for="<%=mode.equals("outStock")?"用途":"退库原因"%>" width="9%" class="td_lefttitle" nowrap><%=mode.equals("outStock")?"用途":"退库原因"%><span class="MustFillColor">*</span>：</td>
				      <td width="89%" colspan="3">
