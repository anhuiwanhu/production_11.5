...
<body class="MainFrameBox">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="listTable">
        ...
        <tr class="listTableHead">
			...
			<td whir-options="field:'meetingDate', width:'10%',allowSort:true,renderer:showTime">会议时间</td> 
            <td whir-options="field:'name', width:'15%',allowSort:true">会议室名称</td>
            <td whir-options="field:'bdroomAppType', width:'8%'">类型</td>
            <td whir-options="field:'applyEmpName',width:'10%'">申请人</td> 
			<td whir-options="field:'applyOrgName', width:'18%'">申请人部门</td> 
            <td whir-options="field:'status', width:'7%',renderer:showStatus">状态</td>
	...
	function showMotif(po,i){
	 ...
	 function showTime(po,i){
		...
		html=meetingDate.substring(0,10)+'<br/>'+meetingDate.substring(10,meetingDate.length);
		return html;
	 }
