...
if(request.getParameter("gd") != null) {
	...
	rd.write("<html><head><title>"+title+"</title> <meta http-equiv='Content-Type' content='text/html;charset=utf-8'/>"+
    "<meta http-equiv='X-UA-Compatible' content='IE=EmulateIE8' /> <script type='text/javascript'> var whirRootPath = '/defaultroot'; "+
	"var preUrl = '/defaultroot'; var whir_browser = ''; var whir_agent = 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko';"+ 
	"var whir_locale = 'zh_cn'; </script>"+
	"<script src='/defaultroot/scripts/jquery-1.8.0.min.js' type='text/javascript'></script>"+
	"<script src='/defaultroot/scripts/i18n/zh_CN/CommonResource.js' type='text/javascript'></script>"+
	"<link   href='/defaultroot/themes/common/common.css' rel='stylesheet' type='text/css'/>"+
	"<link   href='/defaultroot/themes/2015/color_lightgreen/style.css' rel='stylesheet' type='text/css'/>"+
	"<script src='/defaultroot/scripts/plugins/lhgdialog/lhgdialog.js?skin=idialog' type='text/javascript'></script>"+
	"<script src='/defaultroot/scripts/plugins/form/jquery.form.js' type='text/javascript'></script>"+
	"<script src='/defaultroot/scripts/main/whir.validation.js' type='text/javascript'></script>"+
	"<script src='/defaultroot/scripts/main/whir.application.js' type='text/javascript'></script>"+
	"<script src='/defaultroot/scripts/main/whir.application_new.js' type='text/javascript'></script></head>");


	
	/*rd.write("<html><head><title>"+title+"</title><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><script src='/defaultroot/scripts/jquery-1.8.0.min.js' type='text/javascript'></script><script src='/defaultroot/scripts/i18n/zh_cn/CommonResource.js' type='text/javascript'></script><link   href='/defaultroot/themes/common/common.css' rel='stylesheet' type='text/css'/><link   href='/defaultroot/themes/2012/blue/style.css' rel='stylesheet' type='text/css'/><style type=\"text/css\">.doc_content{ padding:20px; line-height:100%; height:100%; overflow:visible;}</style><SCRIPT LANGUAGE=\"JavaScript\">function  readyFun(){} </SCRIPT></head>");*/
