...
<body class="MainFrameBox">
	...
	<s:form name="queryForm" id="queryForm" action="${ctx}/WXLocationAction!wxLocationListData.action" method="post" theme="simple">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="SearchBar">  
		...
		<tr>
			...
			<td  class="whir_td_searchinput">
				<input type="text" Class="inputText" id="username" name="username" maxlength="10" />
			</td>
			<td class="whir_td_searchtitle">组织：</td>
			<td  class="whir_td_searchinput">
				<input type="text" Class="inputText" id="orgname" name="orgname" maxlength="10" />
			</td>
		</tr>
		<tr>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="listTable">
        ...
        <tr class="listTableHead">
			...
			<td whir-options="field:'orgName',width:'20%'">部门</td>
			<td whir-options="field:'userName',width:'13%'">姓名</td> 
			...
			<td whir-options="field:'attendanceSource',width:'10%',renderer:sourceFrom">来源</td> 
			<td whir-options="field:'record',width:'10%'">签到次数</td> 
        </tr>
		</thead>
	...
	function myOperate(po,i){
		var html =  '<a href="javascript:void(0)" onclick="javascript:openWin({url:\'/defaultroot/WXLocationAction!wxLocationDetail.action?id='+po.id+'&date='+po.presentTime+'&username='+po.userName+'&orgname='+po.orgName+'\',width:600,height:400,winName:\'详细信息\'});">查看</a>';
		return html;
	}	
