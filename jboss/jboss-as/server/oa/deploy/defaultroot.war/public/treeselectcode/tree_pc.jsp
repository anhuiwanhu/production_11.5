...
<td style="width:36%;height:250px;">

		<select ondblclick="removeOption<%=treeKey%>();" id="select<%=treeKey%>" multiple style="width:200px;height:250px;margin-top:-1px" ></select>
...
<div style="clear:both"></div>
      ...
      <SCRIPT type="text/javascript">
		...
		function autoAdd<%=treeKey%>(event, treeId, treeNode, msg){
			...
			<%}%>
			//只有一个群组时默认展开，且当这个群组只有一个成员时默认选中到右�?
			<% if(treeRange.indexOf("*")<0 && treeRange.indexOf("$")<0 && treeRange.indexOf("@")>=0 ){
