...
<div  id="popToolbar"  <%if(request.getParameter("mopendir")!=null&&request.getParameter("mopendir").toString().equals("1")){ out.println("style=\"display:none\"");}%> >
<div id="commandBar"  <%if(request.getParameter("mopendir")!=null&&request.getParameter("mopendir").toString().equals("1")){ out.println("style=\"display:none\"");}%>>
