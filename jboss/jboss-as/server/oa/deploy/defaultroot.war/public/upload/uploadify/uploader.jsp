...
if(session.getAttribute("userName")!=null){
    ...
    // 模块文件夹
    String dir = request.getParameter("dir")!=null?com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(request.getParameter("dir")):"dir";
    String makeYMdir = request.getParameter("makeYMdir")!=null?com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(request.getParameter("makeYMdir")):"yes";
    // 年月文件夹
    Date now = new Date();
    ...
    try {
        ...
        for (int i = 0; i < fileList.size(); i++) {
            ...
            if (!fi.isFormField()) {
				...
				".tiff|.key|.iso|.ofd|.asf|.wmv|.wav|.swf|.flv|.mp3|.mp4|.rm|.rmvb|.avi|.caf|.amr|.cebx|";
