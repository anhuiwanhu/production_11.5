...
if(null!= uniqueId && !"".equals(uniqueId) && !"null".equals(uniqueId)){
	uniqueId = EncryptUtil.replaceHtmlcode(uniqueId);
}
...
//样式
String style  = request.getParameter("style")!=null?EncryptUtil.htmlcode(request.getParameter("style")):"";
...
String buttonText   = request.getParameter("buttonText")!=null?EncryptUtil.replaceHtmlcode(request.getParameter("buttonText")):Resource.getValue(whir_locale,"common","comm.attupload");
...
String uploadLimit  = request.getParameter("uploadLimit")!=null?EncryptUtil.htmlcode(request.getParameter("uploadLimit")):"0";
if(null!= uploadLimit && !"".equals(uploadLimit) && !"null".equals(uploadLimit)){
	uploadLimit = EncryptUtil.replaceHtmlcode(uploadLimit);
}
...
<script type="text/javascript">
    ...
    var attachPortletSettingId = "<%=EncryptUtil.htmlcode(portletSettingId)%>";
</script>
<%
