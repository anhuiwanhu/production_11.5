...
<title>关于</title>
<script src="<%=rootPath%>/scripts/jquery-1.11.1.min.js" type="text/javascript"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="370" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td colspan=2>版权所有@1998-2016 万户网络技术有限公司。保留所有权利。</td>
        </tr>
        <tr height=26>
            <td>
        ...
        <tr>
            <td colspan=2>
			加密狗授权用户数：&nbsp;<%=dogInfo[1]%><br>
            <%if(dogInfo.length>4){%>
                                        企业号授权用户数：&nbsp;<%=dogInfo[4]%><br>
         ...
         <tr height=26>
            <td>
            EVO版本信息： <%=(evopatchPO!=null&&evopatchPO.getPatchVersion()!=null)?evopatchPO.getPatchVersion():"无"%>
            </td>
        ...
        <tr><td> EVO授权用户数：&nbsp;<%=dogInfo[3]%></td> </tr>
        <tr> 
          <td colspan=2>&nbsp;</td>
        </tr>
        <tr> 
      ...
      <table width="370" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="75"><img src="close.jpg" width="63" height="20"  onclick="window.close()"></td>
        </tr>
      </table></td>
  </tr>
</table>
